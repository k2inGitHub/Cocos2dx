...
CCSprite* KTScrollLayer::createSprite(CCSprite* sp)
{
    ...
    for (int i = 0; i < sp->getChildrenCount(); i++) {
        CCSprite *child = (CCSprite *)sp->getChildren()->objectAtIndex(0);
...
void KTScrollLayer::scrollViewDidScroll(cocos2d::extension::CCScrollView *view)
{
//	CCLOG("scroll");
...
void KTScrollLayer::scrollViewDidZoom(cocos2d::extension::CCScrollView *view)
{
//	CCLOG("zoom");
}
...
bool KTScrollLayer::ccTouchBegan(CCTouch *pTouch, CCEvent *pEvent)
{
...
void KTScrollLayer::ccTouchMoved(CCTouch *pTouch, CCEvent *pEvent)
{
...
void KTScrollLayer::ccTouchEnded(CCTouch *pTouch, CCEvent *pEvent)
{
...
void KTScrollLayer::ccTouchCancelled(cocos2d::CCTouch *pTouch, cocos2d::CCEvent *pEvent)
{
...
KTScrollLayer::KTScrollLayer() : m_nCurPage(-1), m_pScrollView(NULL), m_pages(NULL), m_delegate(NULL), m_bGestureForward(false), m_bScrollCycle(false), m_pShowPages(NULL)
{
